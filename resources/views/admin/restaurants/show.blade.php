...
<div class="container mx-auto p-4">
    ...
    <div class="mb-4">
        ...
        <a href="{{ route('admin.reservations', ['restaurant_id' => $restaurant->id]) }}" class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 ml-2">View Reservations</a>
    </div>
